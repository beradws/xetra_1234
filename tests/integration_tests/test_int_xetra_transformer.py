...
from xetra_1234.xetra.common.s3 import S3BucketConnector
from xetra_1234.xetra.common.constants import MetaProcessFormat
from xetra_1234.xetra.transformers.xetra_transformer import XetraETL, XetraSourceConfig, XetraTargetConfig
...
class IntTestXetraETLMethods(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.s3_bucket_name_src = 'bvb-xetra-int-test-src'
        self.s3_bucket_name_trg = 'bvb-xetra-int-test-trg'
